"""CLI to test Travel Butler with real tool-calling and itinerary JSON generation."""
...
from api.schemas.itinerary import (
    Itinerary, ItineraryStep, StepType, StepStatus, Location,
...
async def main():
    print(f"\n{B}🧳 Travel Butler CLI{X}")
    print("─" * 40)
    print("Chat naturally. The butler will build your itinerary.")
        ...
        try:
            ...
            if "tool_calls" in result and result["tool_calls"]:
                for tc in result["tool_calls"]:
                    ...
                    if name == "itinerary_generate" or name == "itinerary.generate":
                    ...
                    elif name == "itinerary_execute" or name == "itinerary.execute":
